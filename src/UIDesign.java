...
public class UIDesign extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		/*
		 * new Person("Jacob", "Smith", "jacob.smith@example.com"), new
		 * Person("Isabella", "Johnson", "isabella.johnson@example.com"), new
		 * Person("Ethan", "Williams", "ethan.williams@example.com"), new
		 * Person("Emma", "Jones", "emma.jones@example.com"), new
