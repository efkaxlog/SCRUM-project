...
public class HeatFluxSensorTest extends TestCase {
	...
	@Before
	public void setUp() {
		hfs = new HeatFluxSensor(3, "Heat Flux Data", "HeatFluxSensor", 12.5f,
				19.8f, 26.6f);
	}
	...
	public void testGetSurfaceTemp() {
		...
		assertEquals("Surface Teamperature doesn't match expected data :",
				19.8f, hfs.getSurfaceTemp());
	}
