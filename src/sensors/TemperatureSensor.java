...
public class TemperatureSensor extends Sensor {
	...
	public TemperatureSensor(int sensorID, String sensorName,
			String sensorType, float airTemp, float surfaceTemp) {
	...
	/**
	 * Change the air temperature value of the Temperature Sensor to the
	 * parameter value
	 * 
	 * @param airTemp
	 */
	...
	/**
	 * Change the surface temperature value of the Temperature Sensor to the
	 * parameter value
	 * 
	 * @param surfaceTemp
	 */
