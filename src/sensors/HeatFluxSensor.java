...
public class HeatFluxSensor extends Sensor {
	...
	/**
	 * Change the heat flux temperature value of the Heat Flux Sensor to the
	 * parameter value
	 * 
	 * @param heatFluxData
	 */
	...
	/**
	 * Change the surface temperature value of the Heat Flux Sensor to the
	 * parameter value
	 * 
	 * @param surfaceTemp
	 */
	...
	/**
	 * Change the air temperature value of the Heat Flux Sensor to the parameter
	 * value
	 * 
	 * @param airTemp
	 */
