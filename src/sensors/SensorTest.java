...
private Sensor sensor1;
	  ...
	  public void setUp()
	  {
		   sensor1= new TemperatureSensor(1, "temperature", "TemperatureSensor",12.5f,33.3f);
	...
	public void testGetSensorType() {
		...
		assertEquals("Sensor Type","TemperatureSensor",sensor1.getSensorType());
	...
	public void testSetSensorType() {
		sensor1.setSensorType("TemperatureSensor");
		assertEquals("New Sensor Type","TemperatureSensor",sensor1.getSensorType());
	}
